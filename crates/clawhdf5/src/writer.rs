...
#[cfg(feature = "parallel")]
use clawhdf5_format::file_writer::IndependentDatasetBuilder;
#[cfg(feature = "parallel")]
use clawhdf5_format::metadata_index::{MetadataBlock, build_dataset_metadata};
...
impl DatasetSpec {
    ...
    pub fn f64(name: &str, data: &[f64]) -> Self {
        ...
        Self {
            name: name.to_string(),
            datatype: clawhdf5_format::type_builders::make_f64_type(),
    ...
    pub fn i32(name: &str, data: &[i32]) -> Self {
        ...
        Self {
            name: name.to_string(),
            datatype: clawhdf5_format::type_builders::make_i32_type(),
            shape: vec![data.len() as u64],
            raw_data: raw,
            chunk_options: ChunkOptions::default(),
            maxshape: None,
